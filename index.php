...
<form action="#">
    ...
    <div>
        ...
        <div>
            <input id="Field1" name="Field12" type="text" class="field text fn" value="" size="8" tabindex="1">
        </div>
    </div>

    <div>
        <label class="desc" id="title13" for="Field13">Phone number</label>
        <div>
            <input id="Field1" name="Field13" type="text" class="field text fn" value="" size="8" tabindex="1">
        </div>
    </div>
    ...
    <div>
        ...
        <div>
            <select id="Field106" name="Field106" class="field select medium" tabindex="11">
                <option value="First Choice">FALSE</option>
                <option value="Second Choice">TRUE</option>
